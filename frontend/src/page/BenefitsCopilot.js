...
const Card3 = ({ image, title, description }) => (
  <div
  className={`font-roboto w-[30px] sm:w-[250px] md:w-[220px] lg:w-[300px] p-3 sm:p-8 md:p-3 m-1.5 text-left`}
...
const BenefitsCopilot = () => {
  return (
    <div className="flex  md:flex-row justify-center items-start mt-16 gap-6">
    <div className="flex flex-col w-1/2">
     ...
     <Card3
      ...
      <div className="flex flex-row justify-start item-left gap-4 w-1/2" >
    ...
    <div className="w-full md:w-1/3 mr-20 ml-2 flex justify-end items-stretch">
